...
const serviceLinks = [
  { label: "GBP Optimization", to: "/gbp-optimization" },
  { label: "Local SEO Services", to: "/local-seo" },
  { label: "Home Services SEO", to: "/home-services" },
  { label: "Law Firm SEO", to: "/law-firms" },
];
    ...
    <footer className="bg-slate-900 text-slate-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-14">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              {socials.map((s) => (
                <a key={s.name} href={s.href} className="w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-slate-700 hover:text-white transition-all duration-200" aria-label={s.name}>
          ...
          <div>
            <h2 className="font-bold text-white mb-5 text-sm uppercase tracking-wider">Get In Touch</h2>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <a href="mailto:info@serpwiser.com" className="text-slate-400 hover:text-white transition-colors text-[15px]">
                  info@serpwiser.com
                </a>
              </div>
              <div className="pt-2">
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-sky-500 text-slate-900 font-semibold text-sm hover:from-cyan-400 hover:to-sky-400 transition-all duration-200 hover:-translate-y-0.5"
                >
                  Get a Free Audit
        ...
        <div className="mt-16 pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-sm">© 2026 SERP WISER. All Rights Reserved.</p>
