...
const steps = [
  {
    ...
    title: "Discovery",
    description: "We analyze your business, audience, and competitors to build a solid foundation for your strategy.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Strategy",
    description: "We craft a customized plan with clear goals, channels, and KPIs tailored to your business.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Execution",
    description: "Our team implements campaigns across SEO, content, social, and paid channels with precision.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Reporting",
    description: "You get transparent, regular reports so you always know how your investment is performing.",
  },
];
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-sky-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-2">How We Work</p>
        <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-4">Our Approach to Delivering Results</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step) => (
            ...
            >
              ...
              <Link to="/contact" className="inline-flex items-center gap-1.5 text-blue-600 font-semibold text-sm hover:gap-2 transition-all">
                Learn More
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
